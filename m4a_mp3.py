...
def convertir_m4a_mp3(arch_entrada, arch_salida, bitrate="96k"):
    print("Iniciando conversión de M4A a MP3...")
    ...
    (
        ffmpeg
        .input(arch_entrada)
        .output(arch_salida, audio_bitrate=bitrate, acodec="libmp3lame")
        .overwrite_output()
        .run(quiet=True)
    )
